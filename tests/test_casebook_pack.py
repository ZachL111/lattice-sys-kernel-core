"""Regression checks for the lattice-sys-kernel-core casebook."""
...
from casebook.harness import assert_expected, lattice_sys_kernel_core_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(lattice_sys_kernel_core_summary(), assert_expected())
